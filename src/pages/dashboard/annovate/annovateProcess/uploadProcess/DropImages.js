      ...
      <div className="flex justify-center">
        <div className="w-full">
          <div className="flex items-start gap-2 mb-4">
            <img className="pt-[0.5%]" src={UploadIcon} alt='upload_icon' />
            <div>
          ...
          <div
            className={`bg-[#fff] h-[100%] px-4 file_container rounded-[10px] ${isDraggingOver ? 'bg-gray-200' : ''}`}
            ...
            <div>
              ...
              <div className="flex justify-center mt-2 mb-[7%]">
                <div>
                  ...
                  <ul className="ml-[9%] instruction_list bg-white w-full">
